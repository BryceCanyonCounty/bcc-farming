...
Config.Farming = {
    {
        ...
        FertName = 'fertilizer', -- This is the database name of the fertilizer required to plant the seed.  [false for none]
    ...
    }, -- too add more plants just copy and paste the table and change what you need
    {
        ...
        FertName = false, -- This is the database name of the fertilizer required to plant the seed. [false for none]

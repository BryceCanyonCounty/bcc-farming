...
-------------------------------------------------Farming Setup!--------------------------------------------------------------
Config.FullWaterBucket =
'wateringcan'               --This is the database name of the full Water Bucket(you will need this item to water your crops)
Config.EmptyWaterBucket =
'wateringcan_empty'         --This is the database name of the empty Water Bucket(You will be able to refill this bucket)
...
Config.Farming = {
    {
        ...
        Type = 'Apples',                  --Set this has to be unique to each plant, once set once do not change it will break the database
        ...
        FertTimeRemove = 60000 * 58,      --amount of time in ms the fertilizer will take off the TimetoGrow (if you do not want to use fertilizer for the plant set this too 0 and the option wont show)
        Seedname = 'Package_Apple_Seeds', --This is the database name of the seed that will be used to plant the plant
        SeedsRequired = 1,                --Amount of seeds required to plant
        HarvestItem = 'consumable_apple', --This is the database name of the item you will recieve when you harvest the plant
        ...
        TimetoGrow = 60000,               --The time in ms it will take the plant to grow (60000 is one minute)
...
Config.Language = {
    ...
    TimerText = 'Minutes remaining for ',
    ReadytoHarvest = ' is ready to harvest',
    HarvestPrompt = 'Harvest ',
    ...
    Nowater = 'No water in wagon or missing an empty bucket',
    WebhookTitle = 'Character Static Id: ',
    Webhook_desc = 'Has planted: ',
    OutOfUses = 'You have run out of uses',
    TrimPlant = 'Trim ',
    FillBucket = 'Fill Bucket',
    FillWagon = 'Fill Wagon',
    UseWagon = 'Use Wagon',
    NoTrim = 'You do not have a plant trimmer',
    TooManyPlants = 'You have too many crops planted',
    OpenedSeeds = 'You ripped open the pack of seeds'
}
